...
class InboundQueue(context: Context) {
    private val file = context.applicationContext.filesDir.resolve("inbound_queue.json")
    private val lock = Any()

    fun enqueue(id: String, from: String, body: String, timeIso: String) {
        synchronized(lock) {
