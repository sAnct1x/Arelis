...
ALLOWED: dict[str, str] = {
    ...
    "overpass-api.de": "Earth-zone OSM webcam tags and optional city-band building footprints",
    "overpass.kumi.systems": "Earth-zone Overpass fallback for webcams and building footprints",
    ...
    "tile.openstreetmap.org": "Earth-zone OSM raster at city scale; Streets overlay stays named roads",
    ...
    "511ia.org": "Earth-zone 511ia events, cameras, and WZDx, only when earth action=live",
    "511mn.org": "Earth-zone 511mn events, cameras, and WZDx, only when earth action=live",
    "511ga.org": "Earth-zone 511ga events, cameras, and WZDx, only when earth action=live",
    ...
    "waqi.info": "credit link required by WAQI terms; named in Earth cites, not fetched",
    "globalfishingwatch.org": "credit link in GFW cite; not a request",
    "api.openaq.org": "Earth-zone OpenAQ locations, only when earth action=live and a key is set",
    "openaq.org": "credit link in OpenAQ cite; not a request",
    "auth.opensky-network.org": "Earth-zone OpenSky OAuth2 token, only when a client is pasted",
    ...
    "weathercam.digitraffic.fi": "Earth-zone Fintraffic weathercam stills, click look-from only",
    "api.algotraffic.com": "Earth-zone ALGO cameras, only when earth action=live; stills on click",
    "cdn3.wowza.com": "Earth-zone ALGO HLS, click look-from only",
    "tmc.deldot.gov": "Earth-zone DelDOT camera inventory, only when earth action=live",
    "video.deldot.gov": "Earth-zone DelDOT video, click look-from only",
    "www.journeys.nzta.govt.nz": "Earth-zone NZTA camera inventory, only when earth action=live",
    "www.trafficnz.info": "Earth-zone NZTA stills, click look-from only",
    "www.livetraffic.com": "Earth-zone NSW Live Traffic stills, click look-from only",
    "wsdot.wa.gov": "Earth-zone WSDOT cameras + alerts, only when earth action=live and a key is set",
    "images.wsdot.wa.gov": "Earth-zone WSDOT stills, click look-from only",
    "wzdx.wsdot.wa.gov": "Earth-zone WSDOT WZDx, only when earth action=live",
    "publicapi.ohgo.com": "Earth-zone OHGO cameras + incidents, only when earth action=live and a key is set",
    "itscameras.dot.state.oh.us": "Earth-zone OHGO stills, click look-from only",
    "drivenc.gov": "Earth-zone DriveNC cameras + WZDx, only when earth action=live",
    "ctroads.org": "Earth-zone CT roads stills, click look-from only",
    "511.nebraska.gov": "Earth-zone Nebraska 511 stills, click look-from only",
    "mapping.modot.mo.gov": "Earth-zone MoDOT camera GIS, only when earth action=live",
    "sfs01-traveler.modot.mo.gov": "Earth-zone MoDOT look-from stills, click only",
    "sfs02-traveler.modot.mo.gov": "Earth-zone MoDOT look-from stills, click only",
    "sfs03-traveler.modot.mo.gov": "Earth-zone MoDOT look-from stills, click only",
    "sfs04-traveler.modot.mo.gov": "Earth-zone MoDOT look-from stills, click only",
    "sfs07-traveler.modot.mo.gov": "Earth-zone MoDOT look-from stills, click only",
    "s2.ozarkstrafficoneview.com": "Earth-zone MoDOT Ozarks stills, click look-from only",
    "511.alaska.gov": "Earth-zone Alaska 511 WZDx, only when earth action=live",
    "511.gnb.ca": "Earth-zone New Brunswick WZDx, only when earth action=live",
    "511.gov.pe.ca": "Earth-zone PEI WZDx, only when earth action=live",
    "511yukon.ca": "Earth-zone Yukon WZDx, only when earth action=live",
    "api.drivetexas.org": "Earth-zone DriveTexas conditions + WZDx, keyed; no cameras",
    "in.carsprogram.org": "Earth-zone Indiana CARS WZDx, only when earth action=live",
    "kscars.kandrive.gov": "Earth-zone Kansas CARS WZDx, only when earth action=live",
    "nvroads.com": "Earth-zone Nevada WZDx, only when earth action=live",
    "verkehr.autobahn.de": "Earth-zone Autobahn GmbH roadworks, only when earth action=live",
    "ws.mapserver.transports.gouv.qc.ca": "Earth-zone Quebec 511 cameras, events, and RWIS",
    "webservices.ingv.it": "Earth-zone INGV FDSN stations, only when earth action=live",
    "geofon.gfz-potsdam.de": "Earth-zone GEOFON FDSN stations, only when earth action=live",
    "service.iris.edu": "Earth-zone IRIS FDSN stations, only when earth action=live",
    "www.earthquakescanada.nrcan.gc.ca": "Earth-zone NRCAN FDSN stations, only when earth action=live",
    "service.geonet.org.nz": "Earth-zone GeoNet FDSN stations, only when earth action=live",
    "eismoinfo.lt": "Earth-zone Lithuania road-weather stations, only when earth action=live",
