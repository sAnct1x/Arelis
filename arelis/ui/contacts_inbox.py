...
class ContactsInboxWindow(QWidget):
    """Frameless smoked plate, same pattern as notifications."""

    closed = Signal()

    def __init__(self, panel: ContactsPanel, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("ContactsInbox")
