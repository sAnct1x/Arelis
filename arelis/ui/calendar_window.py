...
class CalendarWindow(QWidget):
    """Frameless Chrome-sized plate. Hide, do not destroy."""

    closed = Signal()

    def __init__(self, panel: CalendarPanel, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("CalendarWindow")
        self.setWindowTitle("calendar")
        self.resize(*CHROME_TILE_SIZE)
        ...
        plate = GlassFrame(
            self,
            object_name="CalendarWindowGlass",
        ...
        close_btn.setToolTip("Hide calendar (Ctrl+7 to restore)")
