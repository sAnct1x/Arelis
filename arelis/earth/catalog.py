...
LAYERS: tuple[LayerSpec, ...] = (
    ...
    LayerSpec(
        ...
        "simulated shells; live: CelesTrak groups + Starlink sample",
    ...
    LayerSpec(
        ...
        "simulated Kepler; live: CelesTrak stations TLE + SGP4",
    ...
    LayerSpec(
        ...
        "simulated belts; live: USGS all_day GeoJSON",
    ...
    LayerSpec(
        ...
        "simulated climates; live: Open-Meteo current at city pins",
        "Not a forecast model. A few points.",
    ),
    LayerSpec(
        "radio",
        "Radio",
        "Geolocated broadcast transmitters.",
        "simulated FM + Radio Browser; live APRS named stations if keyed",
    ...
    LayerSpec(
        ...
        "live: TfL, Caltrans, NYC, Singapore LTA, Fintraffic, Hong Kong TD, OSM worldwide",
    ...
    LayerSpec(
        ...
        "simulated dots; live: Caltrans LCS + TfL Road + Fintraffic messages. No VIN, no plate",
        "There is no legal global car tracker. Keyless stays a labeled simulation.",
        False,
    ),
    LayerSpec(
        "sites",
        ...
        "bundled public coordinates; live upserts Launch Library pads + NASA EONET events",
