...
CHOICE_CASES: tuple[ChoiceCase, ...] = (
    ...
    ChoiceCase("what's in policy.py?", ("workspace",)),
    ChoiceCase("what does tool_subset do?", ("workspace",)),
    ChoiceCase("show me the Drive strip", ("workspace",)),
    ChoiceCase("how does confirm work", ("workspace",)),
    ...
    ChoiceCase("export this as a csv", ("document",)),
