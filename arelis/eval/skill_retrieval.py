...
RETRIEVAL_CASES: tuple[RetrievalCase, ...] = (
    ...
    RetrievalCase(
        id="integral_selects_science",
        user="what is the integral of x squared sin x",
        must_include=("science",),
        must_exclude=("sms",),
    ...
    RetrievalCase(
        ...
        must_include=("science",),
        must_exclude=("sms",),
        must_offer_tools=("units", "cas"),
        notes="Unit conversion selects science; always-on keeps cas too.",
    ),
    RetrievalCase(
        id="plot_selects_science",
        user="fit a line and plot residuals from this csv",
        must_include=("science",),
        must_exclude=("sms",),
    ...
    RetrievalCase(
        ...
        must_include=("science",),
        must_exclude=("sms",),
        must_offer_tools=("catalog",),
        notes="arXiv asks keep catalog visible and do not pull SMS.",
    ),
    RetrievalCase(
        id="sms_excludes_science",
        user="Text Brian: I'm late",
        must_include=("sms",),
        must_exclude=("science",),
        must_offer_tools=("send_sms",),
    ),
)
