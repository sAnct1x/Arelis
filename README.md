...
The current file is `Arelis-0.2.8-win64-setup.exe` — about 186 MB to
...
```powershell
Get-FileHash .\Arelis-0.2.8-win64-setup.exe -Algorithm SHA256
Get-Content .\Arelis-0.2.8-win64-setup.exe.sha256
```
...
published installer is **0.2.8**; see
